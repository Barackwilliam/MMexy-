# Generated by Django 5.2 on 2025-11-14 14:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('level', models.CharField(choices=[('Local', 'Local'), ('VIP', 'VIP'), ('VVIP', 'VVIP')], max_length=10)),
                ('price_per_person', models.DecimalField(decimal_places=2, max_digits=10)),
                ('family_price', models.DecimalField(decimal_places=2, max_digits=10)),
                ('duration', models.CharField(max_length=100)),
                ('max_group_size', models.IntegerField()),
                ('cancellation_policy', models.TextField()),
                ('feature', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='travello.feature')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('package', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='travello.package')),
            ],
        ),
        migrations.CreateModel(
            name='AddOn',
